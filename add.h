...
//getstart มีไว้เพื่อเรียกหมากออกมาอยู่บนรางเดินจุดเริ่มต้น ซึ่งแต่ละสีเริ่มที่จุดต่างกัน
...
int move_green(int& x, int& y, int dice) {
    //เช็คว่าหมากกำลังอยู่ในเลนเส้นชัยหรือไม่
    if (x >= 375 && x < 675 && y == 450) {
        if (dice <= (675 - x) / w) {//หากลูกเต๋าที่ทอยได้มีค่าไม่เกินเส้นชัยก็ให้เดินต่อ
            x += (dice * w);
        }
        if (x == 675 && y == 450) {//เมื่อหมากมาถึงเส้นชัยจะreturnค่า1
            Finished = 1;
            timeToRoll = 1;
            return 1;
        }
    ...
    else for (int i = 0; i < dice; i++)
    {
        ...
        //เดินหมากในแนวแกน x ทิศขวา
        else if (x >= 825 && x < 1075 && y == 400)
        {
            x = x + w;
        }
        //เดินหมากในแนวแกน y ทิศลง
        ...
        //เลนที่กำลังจะถึงเส้นชัย หมากเดินหน้า
...
int move_blue(int& x, int& y, int dice)
{
    ...
    if (x <= 1075 && x > 775 && y == 450) {
        if (dice <= (x - 775) / w) { //หากลูกเต๋าที่ทอยได้มีค่าไม่เกินเส้นชัยก็ให้เดินต่อ
            x -= (dice * w);
        }
        if (x == 775 && y == 450) {//เมื่อหมากมาถึงเส้นชัยจะreturnค่า1
            Finished = 1;
            timeToRoll = 1;
            return 1;
        }
    ...
    else for (int i = 0; i < dice; i++)
    {
        ...
        else if (x == 825 && y == 500) //จุดกระโดด 1
        {
            x = 775;
            y = 550;
        }
        ...
        else if (x == 675 && y == 550) //จุดกระโดด 2
        {
            x = 625;
            y = 500;
        }
        ...
        else if (x == 625 && y == 400) //จุดกระโดด 3
        {
            x = 675;
            y = 350;
        }
        ...
        else if (x == 775 && y == 350) //จุดกระโดด 4
        {
            x = 825;
            y = 400;
        }
        ...
        else if (x <= 1075 && x > 775 && y == 450) //เลนที่กำลังจะถึงเส้นชัย หมากเดินถอยหลัง
        {
            x -= w;
        }
    }
